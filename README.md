...
This initiative is to reessess the use of the Internet Protocol (IP) stack for deep space use. It is an alternative to the use of the [Bundle Protocol](https://datatracker.ietf.org/doc/rfc9171/) to create a network in deep space. It is a reassessment of [RFC4838](https://datatracker.ietf.org/doc/html/rfc4838).

# Discussion
Discussions are happening on the deepspace IETF mailing list.

- [to subscribe](https://www.ietf.org/mailman/listinfo/deepspace)
